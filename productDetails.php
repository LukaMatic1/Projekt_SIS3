      ...
      <div class="col-md-10">
        ...
        <?php
          ...
          if(isset($_GET['searchDataProduct'])){
                  ...
                  echo "<div class='col-md-4 mb-2'>
                          <div class='card'>
                            ...
                            <div class='card-body'>
                              ...
                              <a href='#' class='btn btn-secondary'>Podrobnosti</a>
                            </div>
                          </div>
                        </div>";
            ...
            // poglej detajle izdelka
            if(isset($_GET['productId'])){
                if(!isset($_GET['category'])){
                  if(!isset($_GET['brand'])){
                    $productId=$_GET['productId'];  
                    $selectQuery="SELECT * FROM `Izdelek` WHERE Id_izdelek=$productId";
                    $resultQuery=mysqli_query($con,$selectQuery);
                      ...
                      $slika = $row['Slika'];
                        ...
                        echo           "</div>
                              ...
                              <div class='col-md-8'>
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <h4 class='text-center text-info mb-5'>Podobne slike</h4>
                                    </div> 
                                    <div class='col-md-6'>
                                        <div class='card'>
                                            <img class='card-img-top' src='data:image/jpeg;base64,".$slika."' alt='Card image cap'>
