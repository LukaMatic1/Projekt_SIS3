<h3 class="text-center text-success">Plačana naročila</h3>
<table class="table table-bordered mt-5">
    <thead class="bg-info">

    <?php
        $getOrder="SELECT * FROM `Narocila` WHERE NOT Status_narocila='V teku'";
        ...
        if($row_count==0){
            ...
            while($rowData=mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td>$orderDate</td>
                    <td>$orderStatus</td>
                    <td><a href='index.php?deletePayment=$orderId' class='text-light'><i class='fa-solid fa-trash'></i></a></td>
                </tr>";
            } 
        }   
