        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <form action="" method="post">
                    ...
                    <div>
                        <input type="submit" class="bg-info py-3 px-3 border-0" name="adminLogin" value="Prijava">
                        <p class="small fw-bold mt-2 pt-1">Nimate še profila? <a href="adminRegistration.php" 
